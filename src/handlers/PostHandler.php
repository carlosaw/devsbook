...
class PostHandler {
    ...
    public static function _postListToObject($postList, $loggedUserId) {
        ...
        foreach($postList as $postItem) {
            ...
            if($postItem['id_user'] == $loggedUserId) {// Se for usuario logado post fica true
                $newPost->mine = true;
            }
        ...
        // 4. Preencher as informações adicionais no post.
            ...
            // TODO: 4.1 Preencher informações de LIKES
    ...
    public static function getUserFeed($idUser, $page, $loggedUserId) {
        ...
        $postList = Post::select()
            ...
            ->page($page, $perPage)//Pega a pg e itens por pagina
        ->get();
        ...
        $pageCount = ceil($total / $perPage);//Total de pgs
    ...
    public static function getHomeFeed($idUser, $page) {//Pagina
        $perPage = 2;
        ...
        // 2. Pegar os posts dessa galera pela data.
        $postList = Post::select()
